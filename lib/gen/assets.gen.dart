...
class $AssetsImgGen {
  ...
  /// File path: assets/img/Profiile.png
  AssetGenImage get profiile => const AssetGenImage('assets/img/Profiile.png');
  ...
  /// File path: assets/img/mictophone.png
  AssetGenImage get mictophone =>
      const AssetGenImage('assets/img/mictophone.png');
